...
const currentDirname = path__default["default"].dirname(currentFilename);
...
const normalizeOpinionatedCSS = path__default["default"].join(normalizeDir, 'opinionated.css');
...
const sanitizeUiMonospace = path__default["default"].join(sanitizeDir, 'ui-monospace.css');
